...
DIFFUSION_MODEL_PATH = "F:\\stable-diffusion\\flux-klein\\flux-2-klein-4b.safetensors"
LLM_PATH = "F:\\stable-diffusion\\flux-klein\\Qwen3-4B-Q8_0.gguf"
VAE_PATH = "F:\\stable-diffusion\\flux-klein\\ae.safetensors"
...
def test_flux_klein():
    ...
    image.save(f"{OUTPUT_DIR}/flux_klein.png", pnginfo=pnginfo)
...
#     "--offload-to-cpu",
#     "--output",
#     f"{OUTPUT_DIR}/flux_klein_cli.png",
#     "-v",
# ]
# print(" ".join(cli_cmd))
